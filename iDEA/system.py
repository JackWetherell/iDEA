...
class System:
    ...
    def x(self, value):
        ...
        warnings.warn("x grid has been changed: dx has been recomputed, please update v_ext and v_int on this grid.", stacklevel=2)
